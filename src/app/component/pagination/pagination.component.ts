...
import { isInteger, toNumber, InputBoolean, InputNumber, NzI18nInterface } from './pagination.util';
import { NzPaginationI18nInterface, IndexableObject } from './pagination.util';

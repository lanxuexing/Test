...
@Directive({
  selector: '[appTooltipWindow]'
})
export class TooltipWindowDirective implements OnDestroy, OnChanges {
  @Input('appTooltipWindow') contents: string; // tslint:disable-line no-input-rename

...
import { reqAnimFrame } from '../animation/request.animation';
...
export function SCROLL_SERVICE_PROVIDER_FACTORY(doc: Document, scrollService: ScrollService): ScrollService {
